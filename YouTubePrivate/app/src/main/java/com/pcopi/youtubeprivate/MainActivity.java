...
public class MainActivity extends Activity {
    WebView web; EditText search; View customView; WebChromeClient.CustomViewCallback customCallback; View rootView;
    ...
    void exitFull(){
        ...
        if(rootView!=null){setContentView(rootView);rootView.setVisibility(View.VISIBLE);}
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED);
        showBars();
        old.setVisibility(View.GONE);
    }
    void buildUi(){
        LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setBackgroundColor(Color.rgb(15,15,15));rootView=root;
