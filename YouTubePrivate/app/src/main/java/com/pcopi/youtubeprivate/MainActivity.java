...
public class MainActivity extends Activity {
    ...
    void buildUi(){
        ...
        web.setWebViewClient(new WebViewClient(){
            @Override public void onPageFinished(WebView v,String u){super.onPageFinished(v,u);if(!restoring&&!pageFullscreen&&customView==null&&isWatchUrl(u)){new Handler().postDelayed(()->{if(!pageFullscreen&&customView==null)enterPageFull();},250);}}
