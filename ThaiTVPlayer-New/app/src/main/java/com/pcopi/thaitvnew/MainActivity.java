...
public class MainActivity extends ComponentActivity {
    ...
    private void addNav(LinearLayout p,String s,Runnable c){TextView t=tv(s,16);t.setPadding(dp(22),0,dp(8),0);p.addView(t,new LinearLayout.LayoutParams(-1,dp(54)));t.setOnClickListener(v->{drawer.closeDrawers();c.run();});}
